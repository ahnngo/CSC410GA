...
class genome {
  ...
  public:
    ...
    void deallocate(); // free up the space that is pointed to by genes and sets nGenes to zero
    ...
    int getRed(int index, int value); // get Red
    int getGreen(int index, int value); // get Green
    int getBlue(int index, int value); // get Blue
